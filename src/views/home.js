...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>US Silt</title>
        <meta property="og:title" content="US Silt" />
      </Helmet>
      ...
      <div className="home-hero">
        <div className="home-container2">
          <h1 className="home-text">Test things are very simple</h1>
          ...
          <div className="home-links-container">
            <div className="home-container4">
              <div className="home-product-container">
                <span className="home-text14">Product</span>
              ...
              <div className="home-company-container">
                ...
                <span className="home-text22">Contact</span>
                <span>Blog</span>
              </div>
            </div>
            <div className="home-container5">
              <div className="home-contact">
                ...
                <span className="home-text25">hello@teleporthq.io</span>
                <span>+123 (4567) 890</span>
              </div>
              <div className="home-socials">
                <span className="home-text27">Follow Us</span>
